...
function Perfil() {
  ...
  const salvar = async () => {
    if (dados.senhaPublica && !/^\d+$/.test(dados.senhaPublica)) {
  ...
  return (
    <div className="container mt-5">
      ...
      <textarea className="form-control mb-2" placeholder="Alergias"
        onChange={(e) => setDados({...dados, alergias: e.target.value})} />
      <input type="password" className="form-control mb-3" placeholder="Senha Pública (somente números)"
